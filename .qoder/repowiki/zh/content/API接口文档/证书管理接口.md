...
**图表来源**
- [backend/app/api/certs.py:1-1168](file://backend/app/api/certs.py#L1-L1168)
...
- [frontend/src/api/certs.js:1-64](file://frontend/src/api/certs.js#L1-L64)
- [frontend/src/views/Certs.vue:1-637](file://frontend/src/views/Certs.vue#L1-L637)
...
**章节来源**
- [backend/app/api/certs.py:11-1168](file://backend/app/api/certs.py#L11-L1168)
- [backend/app/utils/ssl_checker.py:1-614](file://backend/app/utils/ssl_checker.py#L1-L614)
...
- [backend/app/api/certs.py:591-808](file://backend/app/api/certs.py#L591-L808)
...
- **上传证书文件**
  ...
  - 参数：id（整数）
  - 请求体：multipart/form-data，包含cert_file（必填）、key_file（可选）
  - 返回：状态码、上传结果、文件路径
  - 权限：需JWT认证且角色为admin或operator
- **下载证书文件**
...
**章节来源**
- [backend/app/api/certs.py:95-175](file://backend/app/api/certs.py#L95-L175)
- [backend/app/api/certs.py:265-371](file://backend/app/api/certs.py#L265-L371)
- [backend/app/api/certs.py:373-588](file://backend/app/api/certs.py#L373-L588)
- [backend/app/api/certs.py:591-808](file://backend/app/api/certs.py#L591-L808)
- [backend/app/api/certs.py:880-1053](file://backend/app/api/certs.py#L880-L1053)
- [backend/app/api/certs.py:1056-1167](file://backend/app/api/certs.py#L1056-L1167)
- [backend/app/api/certs.py:811-877](file://backend/app/api/certs.py#L811-L877)
...
#### 同步步骤
1. **账户验证**：验证阿里云账户ID和状态
2. **证书扫描**：调用阿里云API获取证书列表
3. **信息对比**：比较本地证书与云端证书的有效期
4. **文件下载**：自动下载缺失的证书文件
5. **状态更新**：更新数据库中的证书状态
