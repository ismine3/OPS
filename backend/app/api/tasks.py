        ...
        builtin_tasks = [
            {
                ...
                'is_active': scheduler.get_job('builtin_cert_check_notify') is not None if scheduler.running else False,
                'is_builtin': True,
                'script_files': [],
                'script_content': None,
                'script_path': None,
            ...
            },
            {
                ...
                'is_active': scheduler.get_job('builtin_domain_notify') is not None if scheduler.running else False,
                'is_builtin': True,
                'script_files': [],
                'script_content': None,
                'script_path': None,
            ...
            },
            {
                ...
                'is_active': scheduler.get_job('builtin_password_rotation') is not None if scheduler.running else False,
                'is_builtin': True,
                'script_files': [],
                'script_content': None,
                'script_path': None,
