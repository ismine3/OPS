...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'projects/:id', name: 'ProjectDetail', component: () => import('../views/ProjectDetail.vue'), meta: { title: '项目详情', requiresAuth: true } },
      ...
      { path: 'accounts', name: 'Apps', component: () => import('../views/Apps.vue'), meta: { title: '账号管理' } },
