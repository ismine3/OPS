<template>
  <div class="page-container">
    ...
    <el-card class="search-card">
      <el-form :model="searchParams" inline>
        ...
        <el-form-item style="float: right;">
          ...
          <el-button type="warning" :icon="Connection" @click="handleSyncDialog">云同步</el-button>
    ...
    <!-- 云同步弹窗 -->
    <el-dialog v-model="syncDialogVisible" title="云同步" width="400px" destroy-on-close>
...
async function handleUploadCreate() {
  ...
  try {
    ...
    if (uploadCreateForm.project_id) {
      formData.append('project_id', uploadCreateForm.project_id)
    }
