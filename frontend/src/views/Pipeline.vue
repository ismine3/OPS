            ...
            >
              ...
              <div v-else class="field-wrapper">
                <el-select
                  ...
                  @change="(val: string) => handleFieldChange(field.config_key, val)"
                >
                  <el-option
...
import { Search, Setting, Monitor, Delete, Plus } from '@element-plus/icons-vue'
import {
  getPipelineConfig,
  generatePipeline,
  getGenerations,
...
// ---- Tabs ----
const activeTab = ref<PipelineType>('backend')
...
async function loadConfig() {
  try {
    const res: any = await getPipelineConfig(activeTab.value)
